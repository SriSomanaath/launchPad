...
export default function LayoutWrapper({ children }: { children: React.ReactNode }) {
  ...
  const excludeLayoutPaths = ["/auth/login", "/home", "/hand-pick-candidates", "/certifications", "/latest-trends", "/free-courses", "/profile", "/applications-status", "/events", "/create-dashboard", "/recruiting-home", "/post-job", "/start-here", "/courses"];

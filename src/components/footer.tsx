...
export const Footer = () => {
  ...
  return (
    <footer className="relative border-t bg-background text-foreground transition-colors duration-300">
      <div className="pt-12">
        <div className="px-4 md:px-6 lg:px-8 grid gap-12 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="text-white bg-black px-4 md:px-6 lg:px-8 mt-12 flex flex-col items-center justify-between gap-4 border-t py-4 text-center md:flex-row">
